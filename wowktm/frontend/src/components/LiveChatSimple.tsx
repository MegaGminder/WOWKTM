...
const LiveChat: React.FC = () => {
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="w-16 h-16 bg-wowktm-primary text-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center relative hover:scale-110"
        >
          {unreadCount > 0 && (
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div 
        className={`w-96 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden transition-all duration-300 ${isMinimized ? 'h-16' : 'h-96'}`}
        style={{ opacity: 1 }}
      >
        {/* Header */}
