  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-screen sm:h-screen lg:h-screen overflow-hidden bg-gradient-to-br from-orange-900 via-red-900 to-yellow-900" style={{ minHeight: '100vh' }}>
        {/* Nepali Cultural Background - Static */}
        <div
        ...
        {/* Static Nepali Cultural Animation */}
        ...
        {/* Content Layer */}
        <div className="relative z-20 h-full flex items-center justify-center -mt-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">

            {/* Enhanced Subtitle with Reduced Animations */}
            <div className="mb-8 sm:mb-12">
              ...
              <div className="relative">
                <p
                  className="text-base sm:text-lg md:text-xl font-medium max-w-2xl mx-auto relative z-10 px-4 text-white"
                  style={{
            ...
            <div className="relative group px-4">
              <Link
                to="/products"
                className="group relative inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 lg:px-12 lg:py-6 text-sm sm:text-lg lg:text-xl font-bold text-white bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-full transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                style={{
